...
export const Contact=()=>{
    ...
    const[formDetails,setDetails]=useState(formInitialDetails);
...
method:"POST",
headers:{
    "Content-Type":"Application/json;chargeset=utf-8",
...
body:JSON.stringify(formDetails),
    ...
    if(result.code===200){
        ...
        setStatus({success:false,message:'Something went wrong,please try later'});
    }
    }
    return(
